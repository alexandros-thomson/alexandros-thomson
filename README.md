...
- 🧱 **[Kypria Frontend](https://github.com/alexandros-thomson/kypria-frontend)** — Public-facing shrine website on Netlify
- 🛢️ **[Supabase Schema](https://github.com/alexandros-thomson/kypria-supabase)** — Ceremony logs, sponsor records, artifact ledger
- 📊 **[Grafana Observatory](https://github.com/alexandros-thomson/kypria-grafana)** — Real-time dashboards tracking shrine health, pledges, and embed activity
- 🐳 **[Docker Reliquary](https://github.com/alexandros-thomson/kypria-docker)** — Portable relics for self-hosted ceremonial stacks

---

<details>
  <summary>**🪶 Hall of Stewards** — Contributors to the Canon</summary>
  
  A roll of honor for those who inscribe code, open issues, or champion PRs.
  
  - **[TBD]** — First Steward awaits
  - *Your name here upon contribution*

</details>

<details>
  <summary>**🗄️ Artifact Registry** — Inscribed Works</summary>
  
  A living index of relics, badges, seals, and ceremonial drops. See also: [Shrine Canon](https://github.com/alexandros-thomson/shrine-canon).
  
  - Seal: Basilica Crest — v1
  - Badge: First Echo — v1
  - Relic: Lineage Map — v1
...
## 🕯️ Ritual Contribution

Choose your path and perform the rite. All paths welcome both novices and veterans.

<details>
  <summary>Path I — Forge a Blessing (Sponsor)</summary>
  
  1. Visit the [Sponsorship Altar](https://github.com/sponsors/alexandros-thomson)
  2. Select your tier; the Shrine Watcher verifies your pledge
  3. Receive your Discord role and public inscription in the Artifact Log
...
<details>
  ...
  1. Fork this repository or a linked shrine
  2. Create a branch: `feat/ritual-name`
  3. Commit your work with a `chore(rite):`, `feat(seal):`, or `fix/omen:` prefix
  4. Open a PR titled **Ritual:** Your change
  5. Upon merge, your name is echoed in the Hall of Stewards
...
<details>
  ...
  1. Open an issue with the **Omen** or **Petition** template
  2. Label with `rite`, `seal`, or `canon`
  3. Discuss, refine, and prepare the rite for inscription

</details>

<p align="center" class="shrine-inscription">
  <strong>— ϟ — Rite complete? Inscribe your PR and be counted — ϟ —</strong>
</p>
...
<p align="center" class="shrine-inscription">
  <strong>— ϟ — Blessings upon all Stewards, Keepers, and Contributors to the Mythic Canon — ϟ —</strong>
</p>
